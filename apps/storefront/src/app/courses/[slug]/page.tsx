...
import type { CourseDto, ReviewDto } from '@/lib/api';
import { getCourseBySlug, listCourseReviews, createCourseReview } from '@/lib/api';
...
export default function CourseLandingPage() {
  ...
  useEffect(() => {
    ...
    getCourseBySlug(slug)
      .then((data) => {
        ...
        // Fetch reviews
        return listCourseReviews(data.id);
      })
      .then((reviewsData) => {
  ...
  const handleSubmitReview = async () => {
    if (!course || !newReview.review.trim()) return;
        ...
        <div className="lg:col-span-2">
          ...
          {course.instructorBio && (
            <div className="mt-8">
              ...
              <p className="mt-3 text-gray-700 whitespace-pre-wrap">{course.instructorBio}</p>
            </div>
          )}
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-gray-500">
                or purchase with linked product
              </p>

              <button className="mt-6 w-full rounded-md bg-indigo-600 px-4 py-3 text-sm font-medium text-white hover:bg-indigo-700">
                Enroll Now
              </button>

              <p className="mt-4 text-xs text-gray-500">
                This course includes lifetime access to all course materials
              </p>
            </div>
            ...
            <div className="mt-6 space-y-3 border-t border-gray-200 pt-6">
              ...
              {estimatedHours > 0 && (
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900">{estimatedHours} hours</span>
                </div>
              )}
              {totalLessons > 0 && (
                <div className="flex items-center justify-between text-sm">
